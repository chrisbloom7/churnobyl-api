...
class RandomTableGenerator < Rails::Generators::NamedBase
  ...
  def copy_random_table_file
    template 'random_table_spec.erb', "spec/models/random_tables/#{file_name.singularize}_spec.rb"
    template 'random_table.erb', "app/models/random_tables/#{file_name.singularize}.rb"
    template 'random_table.yml.erb', "db/random_tables/#{plural_file_name}.yml"
  end
